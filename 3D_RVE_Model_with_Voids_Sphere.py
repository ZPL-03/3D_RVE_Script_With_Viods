...
def create3DRVEModelWithVoids(modelName='RVE_3D_with_Voids',
    ...
    """创建带多空隙(球体)缺陷的三维RVE模型主函数"""

    print("\n" + "=" * 70)
    print("Starting 3D RVE Model Generation (WITH MULTI-SPHERE-VOID DEFECTS)")
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 70)
    print("Starting 3D RVE Generation (Fiber First / V-V/F-V Center Check / Node-Pairing-PBC Version)...")
    print("=" * 70)
